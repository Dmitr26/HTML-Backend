The main task of the fourth level (HTTP. Requests. Backends): create a function that accepts data from the API and creates data tables where the user can add, edit and delete data.
